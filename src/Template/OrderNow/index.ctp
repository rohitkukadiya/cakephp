                    ...
                    <div class="row">
                                    ...
                                    <div class="step_1">
                                        ...
                                        <div class="conversion">
                                            <ul>
                                                ...
                                                <li>
                                                    <a data-price="99" data-price-inner="99" href="#" type="other">
                                                        <h5 class="pro_type">Other</h5>
                                                        <p class="proj_charge"><span class="main_page_price">$99</span></p>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        <input class="form-control" id="project_type" name="project_type" type="hidden" value="">
                                        <div class="num_pages">
                                            <ul>
                                                <li>
                                                    ...
                                                    <div class="trigger">
                                                        ...
                                                        <input type="hidden" name="total_pages" id="page_counter" value="1">
                                                    </div>
                                                </li>
                                                <li>
                                                    <h5>Do you want the website responsive?</h5>
                                                    <div class="checkbox c_radio">
                                                        <label><input type="radio" class="pretty_checkable" name="responsive" value="yes" checked>Yes</label>
                                                    </div>
                                                    <div class="checkbox c_radio no_margin">
                                                        <label><input type="radio" class="pretty_checkable" name="responsive" value="no">No</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="step_2">
                                        ...
                                        <div class="form-group relative">
                                            ...
                                            <div class="filestackpicker">
                                                ...
                                                <input type="filepicker" data-fp-apikey="AOWYnMBFtQxWIKC7S2g11z" data-fp-multiple="true" onchange="alert(event.fpfile.url)">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <label class="voucher_error">Invalid Coupon Code</label>
                                                    <label class="voucher_sucess">Valid Coupon Code</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order margin_top">
                                            ...
                                            <ul class="check_boxes">
                                                ...
                                                <li>
                                                    <div class="checkbox">
                                                        <label><input type="checkbox" class="pretty_checkable check_second" data-label="" ><span>Please showcase my project.($10 OFF!)</span></label>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <div class="order_summary" id="sticky_box">
                            <div class="mobile_wrap">
                                ...
                                <div class="save">
                                    <p><span class="circle"><i class="fa fa-check" aria-hidden="true"></i></span> You save up to $696 <a href="#">learn how</a></p>
                                </div>
                            </div>
                        </div>
