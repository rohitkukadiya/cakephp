                ...
                <div class="tnc">
                    ...
                    <div class="conditions">						
                        <div class="terms text-center">
                            ...
                            <p>Your unique contact ID is: <span><?php echo $contact['contact_id']; ?></span>. Please keep this ID handy, as we<br> may ask you for it to identify your project if you have to contact us.</p>
