				...
				<div class="tnc">
					...
					<div class="conditions">						
						<div class="terms text-center">
							...
							<p>Your unique quote ID is: <span><?php echo $quote['quote_id']; ?></span>. Please keep this ID handy, as we<br> may ask you for it to identify your project if you have to contact us.</p>
