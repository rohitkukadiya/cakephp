            ...
            <div class="container">
                <div class="banner_descp text-center">
                    ...
                    <div class="btn_group">
                        ...
                        <p><a href="#"><i class="fa fa-lock" aria-hidden="true"></i> We offer a full 100% money back guarantee.</a></p>
                    </div>
                </div>
            </div>
        </section><!-- /.banner -->
                        ...
                        <li>
                            <div class="project no_left">
                                ...
                                <div class="project_overlay">
                                    <h5>NSID</h5>
                                    <p>PSD to HTML</p>
                                    <a href="http://projects.psd4html.com/NSID/" class="btn overlay_btn"><span>visit site</span></a>
                                </div>
                            </div>							
                        </li>
                        <li>
                            <div class="project">
                                ...
                                <div class="project_overlay">
                                    ...
                                    <a href="http://projects.psd4html.com/proisp/" class="btn overlay_btn"><span>visit site</span></a>
                                </div>
                            </div>							
                        </li>
                        <li>
                            <div class="project">
                                ...
                                <div class="project_overlay">
                                    ...
                                    <a href="http://projects.psd4html.com/boldstorm/" class="btn overlay_btn"><span>visit site</span></a>
                                </div>
                            </div>							
                        </li>
                        <li>
                            <div class="project no_right">
                                ...
                                <div class="project_overlay">
                                    ...
                                    <a href="http://projects.psd4html.com/ZapeBox/" class="btn overlay_btn"><span>visit site</span></a>
                                </div>
                            </div>							
                        </li>						
                    </ul>
                        ...
                        <li>
                            ...
                            <div class="form-group">
                                <select class="selectpicker form-control project_type" name="project_type">
                                    <option value="psdtohtml">PSD to HTML5</option>
                                    <option value="psdtowp">PSD to WordPress</option>	
                                    <option value="padtoemail">PSD to Email</option>
                                </select>
                            </div>
                        </li>
                        <li>
