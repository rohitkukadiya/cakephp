...
class OrderNowController extends AppController
{
    ...
    public function index()
    {
        ...
        if(isset($homepagedata['home_page']) && $homepagedata['home_page'] == 'yes'){
           $order['project_type'] = $homepagedata['project_type'];
        ...
        if ($this->request->is('post')) {
            ...
            $order['original_refer'] = $this->request->referer();
    ...
    public function checkout($orderid = NULL)
    {
        ...
        $paypal_id = 'chirag.merchant@gmail.com'; //Business Email
    ...
    public function SetExpressCheckout($products, $charges, $noshipping = '1') {
        ...
        $padata .= '&RETURNURL=' . urlencode('http://localhost/p4h1and1team/order-now/thankyou');
        $padata .= '&CANCELURL=' . urlencode('http://localhost/p4h1and1team/order-now/');
        ...
        $padata .= '&LOGOIMG=http://localhost/p4h1and1team/assets/images/brand-logo.png'; //site logo
    ...
    public function PPHttpPost($methodName_, $nvpStr_) {
        ...
        $API_UserName = urlencode('chirag.merchant_api1.gmail.com');
        $API_Password = urlencode('PNSMSWJM554P3GPH');
        $API_Signature = urlencode('AFcWxV21C7fd0v3bYYYRCpSSRl31AW-sdU1cuAwdPF4xb7zkCDY0iHFS');
    ...
    public function GetTransactionDetails() {
        ...
        $httpParsedResponseAr = $this->PPHttpPost('GetExpressCheckoutDetails', $padata, 'chirag.merchant_api1.gmail.com', 'PNSMSWJM554P3GPH', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AW-sdU1cuAwdPF4xb7zkCDY0iHFS', 'sandbox');
            ...
            if ($this->Payment->save($payment)) {
                ...
                if($count >= 1){
                    foreach ($stmt as $key => $value) {
                        ...
                        if ($value['files_url'] != "") {
                            $fileslink = explode(',',$value['files_url']);
                            
                            $message .= "<b>File Link:</b>" . $value['files_url'];
                        }
                    ...
                    $email->from(['info@p4h1and1team.com' => 'PSD4HTML'])
                            ->to('rohitkukadiya311@gmail.com')
