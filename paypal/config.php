<?php
  ...
  //if(session_id() == '') { session_start(); } //uncomment this line if PHP < 5.4.0 and comment out line above
	...
	if(PPL_MODE=='sandbox'){
		...
		define('PPL_API_USER', 'chirag.merchant_api1.gmail.com');
		define('PPL_API_PASSWORD', 'PNSMSWJM554P3GPH');
		define('PPL_API_SIGNATURE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AW-sdU1cuAwdPF4xb7zkCDY0iHFS');
	}
	else{
